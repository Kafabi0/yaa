...
import 'mobil_info.dart';
class MobilAvailabilityPage extends StatefulWidget {
  const MobilAvailabilityPage({super.key});

  @override
  State<MobilAvailabilityPage> createState() => _MobilAvailabilityPageState();
}

class _MobilAvailabilityPageState extends State<MobilAvailabilityPage> {
  bool _onlyAvailable = false;

  final List<MobilInfo> _beds = [
    MobilInfo("Ambulance", 12, "Tersedia", Colors.green),
    MobilInfo("Mobil Jenazah", 6, "Tersedia", Colors.green),
              ...
              children: [
                Expanded(
                  child: _buildStatItem(
                    "Total Mobil",
                    _beds.fold(0, (sum, mobil) => sum + mobil.count).toString(),
                ...
                Expanded(
                  child: _buildStatItem(
                    "Tersedia",
                    _beds.where((mobil) => mobil.count > 0).length.toString(),
                    Colors.green,
                    Icons.check_circle,
                  ),
                ),
          ...
          Expanded(
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                final bed = filteredMobil[index];
                return GestureDetector(
                  onTap: () {
                    // Navigator.push(
                    //   context,
                    //   MaterialPageRoute(
                    //     builder: (context) => Mobil(mobilInfo: MobilInfo),
                    //   ),
                    // );
                  },
                  child: Container(
