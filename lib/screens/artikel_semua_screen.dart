...
class _AllHealthArticlesPageState extends State<AllHealthArticlesPage>
  ...
  final List<ArticleModel> articles = [
    ...
    ArticleModel(
      id: 2,
      title: '10 Gejala Penyakit Ginjal yang Harus Diwaspadai',
      category: 'Kesehatan Ginjal',
      date: '1 September 2025',
      image: 'assets/images/kidney_symptoms.jpg',
      excerpt: 'Kenali tanda-tanda awal penyakit ginjal untuk penanganan yang lebih cepat dan efektif dalam menjaga fungsi ginjal.',
      readTime: '7 min',
      views: 985,
      url: 'https://www.biofarma.co.id/id/announcement/detail/10-gejala-penyakit-ginjal-yang-harus-diwaspadai',
    ),
    ArticleModel(
      id: 3,
      title: 'Diet Sehat untuk Penderita Gagal Ginjal Kronis',
      category: 'Kesehatan Ginjal',
      date: '30 Agustus 2025',
      image: 'assets/images/kidney_diet.jpg',
      excerpt: 'Panduan lengkap diet khusus untuk penderita gagal ginjal kronis dengan anjuran makanan yang tepat.',
      readTime: '8 min',
      views: 742,
      url: 'https://www.biofarma.co.id/id/announcement/detail/diet-sehat-untuk-penderita-gagal-ginjal-kronis',
    ),
    ArticleModel(
      id: 4,
