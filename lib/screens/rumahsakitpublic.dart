...
class RumahSakitPublicPage extends StatefulWidget {
  const RumahSakitPublicPage({Key? key}) : super(key: key);
...
class _RumahSakitPublicPageState extends State<RumahSakitPublicPage> {
  ...
  Map<String, List<String>> _provinceCities = {
    ...
    'Jawa Barat': ['Bandung', 'Bekasi', 'Bogor', 'Cimahi', 'Cirebon', 'Depok', 'Sukabumi', 'Tasikmalaya', 'Banjar', 'Kuningan', 'Majalengka', 'Indramayu', 'Subang', 'Purwakarta', 'Karawang', 'Garut'],
    'Jawa Tengah': ['Semarang', 'Magelang', 'Pekalongan', 'Purwokerto', 'Salatiga', 'Solo', 'Tegal', 'Yogyakarta'],
  ...
  List<Hospital> _hospitals = [
    Hospital(
      ...
      address: 'Jl. Soekarno-Hatta No.550, Sekejati, Kec. Buahbatu, Kota Bandung, Jawa Barat 40286, Indonesia',
      phone: '(022) 2034953',
      distance: '1.2 km',
      rating: 4.4,
      reviewCount: 2051,
    ...
    Hospital(
      ...
      address: 'Jl. Cihampelas No.161, Cipaganti, Kec. Coblong, Kota Bandung, Jawa Barat 40131',
      phone: '(022) 2032001',
      distance: '3.5 km',
      rating: 4.3,
      reviewCount: 892,
    ...
    Hospital(
      ...
      address: 'Jl. A.H. Nasution No.50, Antapani Kidul, Kec. Antapani, Kota Bandung, Jawa Barat 40291',
      phone: '(022) 7562525',
      distance: '5.1 km',
      rating: 4.4,
      reviewCount: 2013,
    ...
    setState(() {
      ...
      if (_selectedSort == 'Terdekat') {
        _filteredHospitals.sort((a, b) => 
          double.parse(a.distance.split(' ')[0]).compareTo(double.parse(b.distance.split(' ')[0])));
      }
    });
  }
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            padding: EdgeInsets.symmetric(horizontal: 6, vertical: 2), // kurangi padding
            decoration: BoxDecoration(
              border: Border.all(
                color: Color(0xFFFF6B35),
                width: 0.8,
              ...
              children: [
                ...
                Column(
                  children: [
                    // First row: A+, A-, B+, B-
                    Row(
                      children: ['A+', 'A-', 'B+', 'B-'].map((bloodType) {
                        ...
                        return Expanded(
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: stock.available ? Colors.green.withOpacity(0.1) : Colors.red.withOpacity(0.1),
                              borderRadius: BorderRadius.circular(6),
                              border: Border.all(
                                color: stock.available ? Colors.green : Colors.red,
                                width: 1,
                              ),
                            ),
                            child: Column(
                              children: [
                                ...
                                Icon(
                                  stock.available ? Icons.check : Icons.close,
                                  color: stock.available ? Colors.green : Colors.red,
                                  size: 10,
                                ),
                              ],
                    ...
                    Row(
                      children: ['AB+', 'AB-', 'O+', 'O-'].map((bloodType) {
                        BloodStock stock = hospital.bloodStock[bloodType]!;
                        return Expanded(
                          child: Container(
                            margin: EdgeInsets.only(right: 4),
                ...
                Row(
                  ...
                  children: [
                    _buildFacilityInfo('${hospital.facilities['kamarVip']}', 'Kamar VIP', Icons.hotel),
                    _buildFacilityInfo('${hospital.facilities['igd']}', 'IGD', Icons.local_hospital),
                    _buildFacilityInfo('${hospital.facilities['dokter']}', 'Dokter', Icons.person),
                    _buildFacilityInfo('${hospital.facilities['antrian']}', 'Antrian', Icons.queue),
                  ],
                ),
